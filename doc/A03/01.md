...
2. 次に、 `pom-parent` フォルダの中に、[Spring-boot-24.xml](https://raw.githubusercontent.com/gishi-yama/wicket_spring-boot_practice/bumpup/wsbp/pom-parent/spring-boot-24.xml) ファイルをダウンロードしてコピーする。
