...
下記の画像は**最新版にはしてない場合がある**ので、上記の情報をもとにプロジェクトを作ってください。
...
<!---->
### 前準備 spring-boot 3.3 以降用の定義ファイルを作る
...
2. 次に、 `pom-parent` フォルダの中に、[Spring-boot-33.xml](https://raw.githubusercontent.com/gishi-yama/wicket_spring-boot_practice/master/wsbp/pom-parent/spring-boot-33.xml) ファイルをダウンロードしてコピーする。
